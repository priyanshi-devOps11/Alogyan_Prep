...
abstract class AppTheme {
  ...
  static const TextStyle displayDark = TextStyle(
      fontFamily: fontFamily, fontSize: 34, fontWeight: FontWeight.w700,
      color: textOnDark, height: 1.18, letterSpacing: -0.8);

  static const TextStyle bodyOnDark = TextStyle(
      fontFamily: fontFamily, fontSize: 15, fontWeight: FontWeight.w400,
      color: textSecondaryOnDark, height: 1.6);
  ...
  static const TextStyle accentTagDark = TextStyle(
      ...
      color: brandRed, letterSpacing: 1.6);
