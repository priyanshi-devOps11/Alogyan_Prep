...
class OnboardingSlide {
  final String accentTag, title, subtitle, description, assetPath;
...
abstract class OnboardingSlidesData {
  static const List<OnboardingSlide> slides = [
    ...
    OnboardingSlide(
      ...
      description: 'Get daily GK updates filtered by Economy, Politics, Science and more.',
    ...
    OnboardingSlide(
      ...
      description: 'Track test scores, identify weak topics, and get personalised recommendations.',
    ...
    OnboardingSlide(
      ...
      description: 'Download study notes and PDF bundles. Read anytime, anywhere.',
      assetPath: 'assets/images/onboarding_4.png',
    ),
  ];
}

// ── Onboarding steps — THE SINGLE SOURCE OF TRUTH ────────────────────────────
enum OnboardingStep {
  splash,
  welcome,
  name,
...
// ── Collected profile (step by step) ─────────────────────────────────────────
class OnboardingProfile {
  final String? firstName, lastName, email;
  final String? examGoalId, learningStyleId, journeyLevelId;
  final DateTime? dateOfBirth;

  const OnboardingProfile({
    this.firstName, this.lastName, this.email,
    this.examGoalId, this.learningStyleId, this.journeyLevelId,
    this.dateOfBirth,
  });

  OnboardingProfile copyWith({
    String? firstName, String? lastName, String? email,
    String? examGoalId, String? learningStyleId, String? journeyLevelId,
